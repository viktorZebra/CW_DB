...
@section('styles')
    <link href="{{ asset('public/css/opened/index.css') }}" rel="stylesheet">
    <link href="{{ asset('public/css/opened/glide.core.css') }}" rel="stylesheet">
@endsection
@section('content')
                ...
                <ul class="glide__slides">
                    <li class="glide__slide carousel-slide carousel-fade">
                        ...
                        <div class="carousel-text">
                            <h5>Мониторинг внеурочной деятельности.</h5>
                            <p class="text">Курсовой проект по предмету Базы Данных.</p>
                        </div>
                        </div>
                    </li>
                    <li class="glide__slide carousel-slide carousel-fade">
                        ...
                        <div class="carousel-text">
                            ...
                            <p class="text">Единая информационная система учета и мониторинга обучающихся образовательных организаций города Раменское.</p>
                        </div>
                        </div>
                    </li>
                    <li class="glide__slide carousel-slide carousel-fade">
                        <div>
                            ...
                            <div class="carousel-text">
                                ...
                                <p class="text">С нами каждая образовательная организация города Раменское.</p>
                            </div>
                        </div>
                    </li>
                    <li class="glide__slide carousel-slide carousel-fade">
